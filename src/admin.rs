...
#[c2rust::header_src = "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/sys/_types/_iovec_t.h:23"]
pub mod _iovec_t_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "31:1"]
...
#[c2rust::header_src = "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/netdb.h:23"]
pub mod netdb_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
...
#[c2rust::header_src = "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/_regex.h:25"]
pub mod _regex_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
...
#[c2rust::header_src = "/Users/conrad.ludgate/Documents/code/pgbouncer/lib/usual/slab.h:29"]
pub mod slab_h {
    #[c2rust::src_loc = "67:1"]
...
#[c2rust::header_src = "/Users/conrad.ludgate/Documents/code/pgbouncer/lib/usual/endian.h:27"]
pub mod endian_h {
    #[inline]
    #[c2rust::src_loc = "144:1"]
    ...
    pub unsafe extern "C" fn usual_be32dec(mut p: *const ::core::ffi::c_void) -> uint32_t {
        ...
        return usual_bswap32(tmp);
    }
    use super::_size_t_h::size_t;
    use super::_string_h::memcpy;
    use super::_uint32_t_h::uint32_t;
}
#[c2rust::header_src = "/Users/conrad.ludgate/Documents/code/pgbouncer/lib/usual/safeio.h:28"]
pub mod safeio_h {
    use super::_ssize_t_h::ssize_t;
...
#[c2rust::header_src = "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/arm/_param.h:23"]
pub mod _param_h {
...
#[c2rust::header_src = "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/_strings.h:23"]
pub mod _strings_h {
    extern "C" {
        #[c2rust::src_loc = "81:1"]
        pub fn strcasecmp(
...
pub unsafe extern "C" fn admin_ready(
    ...
    return pktbuf_send_immediate(&raw mut buf, admin);
}
...
unsafe extern "C" fn admin_set(
    ...
    if (*admin).admin_user() {
        ...
        if ok {
            ...
            return admin_flush(admin, buf, &raw mut tmp as *mut ::core::ffi::c_char);
        } else {
            return admin_error(
                admin,
...
unsafe extern "C" fn send_one_fd(
        ...
        && (*admin).sbuf.tls.is_null()
    {
        ...
        cmsg = if msg.msg_controllen as usize >= ::core::mem::size_of::<cmsghdr>() as usize {
...
unsafe extern "C" fn dns_name_cb(
    ...
    let mut now = get_cached_time();
        ...
        .offset(::core::mem::size_of::<[::core::ffi::c_char; 1024]>() as usize as isize)
...
unsafe extern "C" fn admin_cmd_suspend(
    ...
    (*admin).set_wait_for_response((true_0 != 0) as bool);
    suspend_pooler();
...
unsafe extern "C" fn admin_cmd_kill(
    ...
    return admin_ready(admin, b"KILL\0" as *const u8 as *const ::core::ffi::c_char);
}
...
pub unsafe extern "C" fn admin_pre_login(
    ...
    (*client).set_admin_user((false_0 != 0) as bool);
    (*client).set_own_user((false_0 != 0) as bool);
    if pga_is_unix(&raw mut (*client).remote_addr) {
            ...
            ) == 0 as ::core::ffi::c_int
        {
            ...
            (*client).set_own_user((true_0 != 0) as bool);
            (*client).set_admin_user((true_0 != 0) as bool);
    ...
    while item != &raw mut (*admin_pool).active_client_list.head {
        ...
        if (*admin).wait_for_response() {
            ...
            if !res {
                ...
                (*admin).set_wait_for_response((false_0 != 0) as bool);
            }
        }
        item = tmp;
        tmp = (*tmp).next;
